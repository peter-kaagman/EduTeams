...
Insert Into magisterleerling ('ROWID','stamnr','b_nummer','upn','naam') values
    (1,'234567','b234567','b234567@ictatlascollege.nl','Test Leerling 1'),
    (2,'234568','b234568','b234568@ictatlascollege.nl','Test Leerling 2'),
    (3,'234569','b234569','b234569@ictatlascollege.nl','Test Leerling 3'),
    (4,'234560','b234560','b234560@ictatlascollege.nl','Test Leerling 4')
;
Insert Into magisterleerlingenrooster ('leerlingid','teamid') values
    ...
    ('4','2')
;
-- Geen Azure gegevens in de database, geen van de teams is dus beken
